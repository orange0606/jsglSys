<template>
  <el-table-column :prop="col.colNum+'.td'" :label="col.td+col.attribute+'('+col.attributeValue+')'" :fit="true" :key="$excel.randomkey(this)" :min-width="$excel.Setwidth(col.td)" :width="$excel.Setwidth(col.td, hd)" :align="col.textAlign">

...
var hiprint = function (t) {
        ...
        this.options = n.data(t.target, "hireizeable").options, this.init(t.target);
            ...
            bindResizeEvent: function bindResizeEvent(t, e) {
                ...
                t.on("mousedown", function (t) {
                    ...
                    h = !1, d = !1, c = !1, f = !1, g = !1, m = !1, y = !1, v = !1, b = !1, i.options.onStopResize();
                });
            },
    ...
    var _r,
        ...
        dt = function () {
            ...
            return Object.defineProperty(t, "Instance", {
                get: function get() {
                    return ht._instance || (t._instance = new t()), t._instance;
                },
                enumerable: !0,
                configurable: !0
            }), t.prototype.createEditor = function (t) {
                return $.extend({}, ht.Instance[t]);
            }, t;
        }(),
        ct = function () {
            function t() { }
        ...
        ft = function () {
            ...
            return t.prototype.clear = function () {
                ...
                if (this.startCell) {
                    ...
                    if (i) {
                        var o = ct.mergeRect(this.startCell.cell.getTableRect(), i.cell.getTableRect());
                        this.selectByRect(new mt(o), n);
                    }
                }
                ...
                this.rows.forEach(function (n, i) {
                    ...
                    n.columns.forEach(function (e) {
                        e.isInRect(t) && (o.push(new vt(i, e)), e.select());
                    }), o.length && e.push(o);
        ...
        bt = function () {
            ...
            return t.prototype.init = function (t, e) {
                ...
                var e = this;
                this.editor = dt.Instance.createEditor("text"), t.getTarget().html(""), this.editor.init(t), (this.title || this.field) && (this.tableOptions.options.isEnableEditField ? this.editor.setValue((this.title || "") + "#" + (this.field || "")) : this.editor.setValue(this.title || "")), $(this.editor.target).keydown(function (n) {
        ...
        Tt = function () {
            return function (t) {
                this.title = t.title, this.field = t.field, this.width = t.width, this.align = t.align, this.vAlign = t.vAlign, this.colspan = t.colspan, this.rowspan = t.rowspan, this.checked = t.checked, this.columnId = t.columnId;
            };
        }(),
        wt = function () {
            function t() {
            ...
            return t.prototype.init = function (t, e, n, i) {
                ...
                if (!this.isEditing && this.tableOptions.isEnableEdit && this.tableOptions.onBeforEdit(this)) {
                    var t = this.getValue();
                    this.editor = dt.Instance.createEditor("text"), this.isEditing = !0, this.tableOptions.editingCell = this, this.target.html(""), this.editor.init(this), this.editor.setValue(t);
                }
                ...
                this.innerElement = new bt(), this.innerElement.init(this, this.tableOptions);
        ...
        Pt = function (t) {
            function e(e) {
                var n = this;
                return e = e || {}, (n = t.call(this) || this).width = e.width ? parseFloat(e.width.toString()) : 100, n.title = e.title, n.field = e.field, n.fixed = e.fixed, n.rowspan = e.rowspan ? parseInt(e.rowspan) : 1, n.colspan = e.colspan ? parseInt(e.colspan) : 1, n.align = e.align, n.vAlign = e.vAlign, n.formatter = e.formatter, n.styler = e.styler, n.checkbox = e.checkbox, n.checked = 0 != e.checked, n.columnId = e.columnId || e.field, n;
            }

            return Et(e, t), e.prototype.css = function (t) { }, e;
        }(wt),
        xt = function () {
            function t() {
                this.name = "columns";
            ...
            return t.prototype.createTarget = function () {
                ...
                var i = this,
                    o = this;
                this.value = t, this.printElementType = n;
                ...
                return this.allColumns.filter(function (t) {
                    ...
                    var o = $(i).attr("column-id"),
                        r = t.printElementType.getColumnByColumnId(o);

                    if (r) {
                        var a = new Pt(r);
                        a.checked = !0, e.push(a);
                    }
        ...
        Dt = function () {
            ...
            }, t._printElementOptionItems = [new s(), new l(), new u(), new h(), new p(), new d(), new c(), new Ct(), new f(), new g(), new m(), new v(), new y(), new b(), new T(), new w(), new E(), new P(), new x(), new C(), new O(), new I(), new H(), new S(), new F(), new D(), new R(), new B(), new z(), new L(), new A(), new N(), new k(), new V(), new j(), new M(), new W(), new G(), new Ot(), new X(), new q(), new U(), new Y(), new J(), new Q(), new K(), new Z(), new tt(), new et(), new it(), new nt(), new ot(), new rt(), new at(), new pt(), new st(), new lt(), new xt(), new It(), new Ht(), new St(), new Ft()], t;
        }(),
        Rt = function () {
            function t() {
            ...
            return t.prototype.init = function (t) {
                ...
                get: function get() {
                    return t._instance || (t._instance = new t(), window.HIPRINT_CONFIG && $.extend(t._instance, HIPRINT_CONFIG), t._instance.optionItems && t._instance.optionItems.forEach(function (t) {
                        console.log(t), Dt.registerItem(t);
                    })), t._instance;
                },
                enumerable: !0,
                configurable: !0
        ...
        zt = function () {
            ...
            return Object.defineProperty(t, "instance", {
                ...
                t.instance.dragingPrintElement = new Bt(e);
        ...
        Vt = function () {
            function t(t) {
                this.printElementType = t, this.id = zt.instance.guid();
            }

            return t.prototype.getConfigOptionsByName = function (t) {
                return Rt.instance[t];
                ...
                this.designTarget.hidraggable({
                    ...
                    moveUnit: "pt",
                    minMove: Rt.instance.movingDistance,
                    onBeforeDrag: function onBeforeDrag(t) {
                ...
                return t ? new At(void 0, this.options.getPrintElementOptionEntity(), this.printElementType.getPrintElementTypeEntity()) : new At(this.printElementType.tid, this.options.getPrintElementOptionEntity());
                ...
                this.isHeaderOrFooter(t) || this.isFixed() || r > a && (o.push(new Nt({
                    target: void 0,
                    printLine: void 0
                })), r = r - a + t.paperHeader, i++ , a = t.getPaperFooter(i));
                var p = this.getData(e),
                    s = this.createTarget(this.getTitle(), p, n);
                return this.updateTargetSize(s), this.css(s, p), s.css("position", "absolute"), s.css("left", this.options.displayLeft()), s.css("top", r + "pt"), o.push(new Nt({
                    target: s,
                ...
                this.isHeaderOrFooter(t) || this.isFixed() || (r > a && (o.push(new Nt({
                    target: void 0,
                    printLine: void 0
                })), r = r - a + t.paperHeader, i++ , a = t.getPaperFooter(i)), r <= a && r + this.options.getHeight() > a && (o.push(new Nt({
                    target: void 0,
                    printLine: void 0
            ...
            }, t.prototype.getPrintElementOptionItemsByName = function (t) {
                var e = [],
                ...
                return t || (t = zt.instance.getPrintTemplateById(this.templateId).getFields());
        ...
        Wt = function (t) {
            ...
            return Mt(e, t), e.prototype.getPrintElementOptionEntity = function () {
                var t = [];
                return this.columns.forEach(function (e) {
                    t.push(e.getEntity());
                }), t;
        ...
        Gt = (function () { }(), function () {
            return function (t) {
                this.width = t.width, this.title = t.title, this.columnId = t.columnId, this.fixed = !1, this.rowspan = t.rowspan || 1, this.colspan = t.colspan || 1, this.align = t.align, this.vAlign = t.vAlign;
            };
        }()),
        Xt = function () {
        ...
        qt = function (t) {
                ...
                (e = e || {}, i = t.call(this, e) || this, n) && (i.columns = [], n.editable && e.columns && e.columns.length ? e.columns.forEach(function (t) {
                    ...
                    t.forEach(function (t) {
                        var i = new Gt(t),
                            ...
                            r = o ? $.extend(o, i) : new Pt(i);
                        r.checked = !0, e.push(r);
                    }), i.columns.push(new Wt(e));
                }) : n.columns.forEach(function (t) {
                    i.columns.push(new Wt(t.filter(function (t) {
                        return t.checked;
                    })));
                }));
                return i;
            ...
            return Xt(e, t), e.prototype.getColumnByColumnId = function (t) {
        ...
        ie = function () {
            ...
            return t.getColumnsWidth = function (e, n) {
                ...
                for (var i = e || new ne(), o = function o(e) {
        ...
        oe = function () {
            ...
            return t.prototype.init = function () {
                ...
                }), this.target.before(i), this.cgripContariner = new te(i, n);
                ...
                }), this.target.before(i), this.rgripContariner = new te(i, n), this.syncRowGrips();
        ...
        ae = function () {
            function t(t) {
                this.id = yt.createId(), this.optionsCoat = new Qt(t), this.handle = t.handle, this.target = t.table, this.initRows(t.rows), this.init(t), this.tableCellSelector = new ft(this.rows, this.target), this.resizer = this.optionsCoat.options.columnResizable ? new oe(this) : new re(), this.resizer.init();
            }
            ...
            return t.prototype.insertRow = function (t, e, n) {
                var i = e || this.tableCellSelector.getSingleSelect(),
                    ...
                    p = this.getCellGrid(),
                    s = new $t();
                if (s.init(this.optionsCoat, void 0, r.isHead), n && s.getTarget().addClass(n), "above" == t) p[a].forEach(function (t) {
                ...
                var t = this.tableCellSelector.getSingleSelect(),
                    e = this.getCellGrid(),
                    n = Zt.getIndex(e[t.rowIndex], t.cell.id);

                if (t) {
                    for (var i = t.rowIndex; i < t.rowIndex + t.cell.rowspan; i++) {
                        for (var o = this.rows[i], r = i == t.rowIndex ? t.cell : Zt.getLeftTableCell(e[i], n), a = 0; a < t.cell.colspan; a++) {
        ...
        le = function (t) {
            function e(e, n) {
                ...
                return i.options = new qt(n, i.printElementType), i.options.setDefault(new qt(Rt.instance.table.default).getPrintElementOptionEntity()), i;
            }

            return se(e, t), e.prototype.getColumns = function () {
                ...
                for (var i = $('<div class="hiprint-printElement hiprint-printElement-table" style="position: absolute;"><div class="hiprint-printElement-table-handle"></div><div class="hiprint-printElement-table-content" style="height:100%;width:100%"></span></div>'), o = this.createGridColumnsStructure(n), r = 0; r < o.gridColumns; r++) {
                    o.getByIndex(r).append(this.getTableHtml(e));
                }

                return i.find(".hiprint-printElement-table-content").append(o.target), i;
            }, e.prototype.createGridColumnsStructure = function (t) {
                ...
                return this.printElementType.gridColumnsFooterFormatter && e.append(this.printElementType.gridColumnsFooterFormatter(t, this.options)), new pe(this.options.getGridColumns(), e);
            }, e.prototype.createtempEmptyRowsTargetStructure = function (t) {
                ...
                return i.append(Yt.createTableHead(this.getColumns(), this.options.getWidth() / this.options.getGridColumns())), i.append(Yt.createTableRow(this.getColumns(), t, this.options, this.printElementType)), this.printElementType.footerFormatter && i.append(Yt.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType)), i;
                ...
                for (var a, p = this.getBeginPrintTopInPaperByReferenceElement(t), s = 0, l = !1; !l;) {
                    ...
                    0 == s && p > h && (p = p - h + t.paperHeader, n.push(new Nt({
                        target: void 0,
                        printLine: void 0
                ...
                for (var s = 0; s < this.options.getGridColumns(); s++) {
                    for (var l = e.find(".hiprint-printElement-tableTarget:eq(" + s + ")"), u = void 0; ;) {
                        if (p <= a) if (0 == r.find("tr").length) u = {
                            height: hinnn.px.toPt(p),
                            isEnd: !0
                        }; else {
                            var h = r.find("tr:lt(1)");
                            l.find("tbody").append(h), (p = e.outerHeight()) > a && (r.prepend(h), p = e.outerHeight(), u = {
                                height: hinnn.px.toPt(p),
                                isEnd: !1
                            });
                        }
                ...
                var d = e.find(".hiprint-printElement-tableTarget tbody tr").length;
                return 0 == r.find("tr").length ? 0 == d && o ? {
                    target: void 0,
                    length: 0,
                    height: 0,
                    isEnd: !0
                ...
                t.prototype.updateSizeAndPositionOptions.call(this, r, o, i, n), Yt.resizeTableCellWidth(this.designTarget, this.getColumns(), this.options.getWidth());
            ...
            }, e.prototype.setColumnsOptions = function () { }, e.prototype.filterOptionItems = function (e) {
                var n = t.prototype.filterOptionItems.call(this, e);
                return this.printElementType.editable && 1 == this.options.columns.length ? n : e.filter(function (t) {
        ...
        ce = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new _t(n), i.options.setDefault(new _t(Rt.instance.image.default).getPrintElementOptionEntity()), i;
            }

            return de(e, t), e.prototype.getReizeableShowPoints = function () {
                return ["se"];
            }, e.prototype.getData = function (t) {
                var e = "";
        ...
        ge = function (t) {
            ...
            return fe(e, t), e.prototype.getHideTitle = function () {
        ...
        me = function () {
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                ...
                return this.mmheight - Rt.instance.paperHeightTrim + "mm";
            }, t.prototype.displayWidth = function () {
        ...
        ye = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new ge(n), i.options.setDefault(new ge(Rt.instance.longText.default).getPrintElementOptionEntity()), i;
            }

            return ve(e, t), e.prototype.getDesignTarget = function (e) {
                ...
                this.createTempContainer();
                var e = this.getPaperHtmlResult(new me("", 1e3, 1e3, 0, 25e3, 0, 0, !0, void 0, 0, void 0), {}, t);
                ...
                }), 0 == l.length && (l = [""]), this.isHeaderOrFooter(t) || this.isFixed() || !e) return (f = this.getStringBySpecificHeight(l, 25e3, s)).target.css("left", this.options.displayLeft()), f.target.css("top", this.options.displayTop()), f.target[0].height = "", o.push(new Nt({
                    target: f.target,
                ...
                for (var h = this.getBeginPrintTopInPaperByReferenceElement(t); l.length > 0;) {
                    ...
                    0 == r && h > c && (h = h - c + t.paperHeader, o.push(new Nt({
                        target: void 0,
                        printLine: void 0
                    ...
                    var g = void 0,
                        m = void 0;
                    f.target.css("left", this.options.displayLeft()), f.target[0].height = "", 0 == r || d > 0 ? (m = h, f.target.css("top", m + "pt"), g = l.length > 0 ? h + f.height : null != this.options.lHeight ? h + (f.height > this.options.lHeight ? f.height : this.options.lHeight) : h + f.height) : (m = t.paperHeader, f.target.css("top", m + "pt"), g = m + f.height), o.push(new Nt({
                        target: f.target,
                        printLine: g,
                        referenceElement: new kt({
                            top: this.options.getTop(),
        ...
        we = function (t) {
            function e(e) {
                ...
                return n.title && (n.title = be.replaceEnterAndNewlineAndTab(n.title, "")), n;
            }

            return Te(e, t), e.prototype.getHideTitle = function () {
                return null == this.hideTitle ? this.defaultOptions.hideTitle : this.hideTitle;
        ...
        Pe = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new we(n), i.options.setDefault(new we(Rt.instance.text.default).getPrintElementOptionEntity()), i;
            }
            ...
            return Ee(e, t), e.prototype.getDesignTarget = function (e) {
                ...
                return Rt.instance.text;
            }, e.prototype.getTitle = function () {
                var t = this.options.title || this.printElementType.title || "";
                return t && (t = be.replaceEnterAndNewlineAndTab(t, "")), t;
            }, e.prototype.getData = function (t) {
                return t ? t[this.getField()] || "" : this.options.testData || this.printElementType.getData() || "";
        ...
        Ie = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new Ce(n), i.options.setDefault(new Ce(Rt.instance.html.default).getPrintElementOptionEntity()), i;
            }

            return Oe(e, t), e.prototype.updateDesignViewFromOptions = function () {
                if (this.designTarget) {
                    var t = this.getData();
        ...
        Se = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new _t(n), i.options.setDefault(new _t(Rt.instance.vline.default).getPrintElementOptionEntity()), i;
            }
        ...
        De = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new _t(n), i.options.setDefault(new _t(Rt.instance.hline.default).getPrintElementOptionEntity()), i;
            }

            return Fe(e, t), e.prototype.updateDesignViewFromOptions = function () {
                if (this.designTarget) {
                    var t = this.getData();
                    this.css(this.designTarget, t);
                }
        ...
        Be = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new _t(n), i.options.setDefault(new _t(Rt.instance.rect.default).getPrintElementOptionEntity()), i;
            }
        ...
        Le = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new _t(n), i.options.setDefault(new _t(Rt.instance.oval.default).getPrintElementOptionEntity()), i;
            }
        ...
        Ae = function () {
            ...
            return t.createPrintElement = function (t, e) {
                return "text" == t.type ? new Pe(t, e) : "image" == t.type ? new ce(t, e) : "longText" == t.type ? new ye(t, e) : "table" == t.type ? new le(t, e) : "html" == t.type ? new Ie(t, e) : "vline" == t.type ? new Se(t, e) : "hline" == t.type ? new De(t, e) : "rect" == t.type ? new Be(t, e) : "oval" == t.type ? new Le(t, e) : void 0;
            }, t;
        }(),
        Ne = function () {
            function t(t) {
            ...
            return t.prototype.getText = function (t) {
                ...
                var e = {};
                return $.extend(e, t || {}), Ae.createPrintElement(this, e);
            }, t.prototype.getPrintElementTypeEntity = function () {
                return new ue({
                    title: this.title,
                    type: this.type
        ...
        Ve = function (t) {
            ...
            return ke(e, t), e.prototype.getPrintElementOptionEntity = function () {
                var e = t.prototype.getPrintElementOptionEntity.call(this);
        ...
        _e = function (t) {
            function e(e, n) {
                var i = t.call(this, e) || this;
                return i.options = new Ve(n), i.options.setDefault(new Ve(Rt.instance.tableCustom.default).getPrintElementOptionEntity()), i.columns = i.options.columns, i;
            }

            return je(e, t), e.prototype.updateDesignViewFromOptions = function () {
                if (this.designTarget) {
                    this.css(this.designTarget, this.getData());
                    var t = this.designTarget.find(".hiprint-printElement-table-content"),
                        e = this.getHtml(this.designPaper);
                ...
                return Rt.instance.tableCustom;
            }, e.prototype.createTarget = function (t, e) {
                ...
                return e.append(Yt.createTableHead(this.columns, this.options.getWidth())), e.append(Yt.createTableRow(this.columns, t, this.options, this.printElementType)), this.printElementType.footerFormatter && e.append(Yt.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType)), e;
            }, e.prototype.getHtml = function (t, e) {
                this.setCurrenttemplateData(e), this.createTempContainer();
                var n = this.getPaperHtmlResult(t, e);
                return this.removeTempContainer(), n;
                ...
                t.prototype.updateSizeAndPositionOptions.call(this, r, o, i, n), Yt.resizeTableCellWidth(this.designTarget, this.columns, this.options.getWidth());
            }, e.prototype.getReizeableShowPoints = function () {
                return ["s", "e"];
            }, e.prototype.design = function (t, e) {
                var n = this;
        ...
        Me = function (t) {
            ...
            return $e(e, t), e.prototype.createPrintElement = function (t) {
        ...
        Xe = function () {
            ...
            return t.createPrintElementType = function (t) {
                return t.type = t.type || "text", "text" == t.type ? new Ge(t) : "table" == t.type ? new he(t) : "tableCustom" == t.type ? new Me(t) : new Ne(t);
            }, t;
        }(),
        qe = function () {
            function t() { }
            ...
            return t.getElementTypeGroups = function (e) {
                ...
                Xe.createPrintElementType({
                    type: e
                });
            }, t.build = function (e, n) {
                var i = t.formatterModule(n),
                    o = new Lt().createPrintElementTypeHtml(e, this.getElementTypeGroups(i));
                this.enableDrag(o);
                ...
                e.hidraggable({
                    ...
                    proxy: function proxy(t) {
                        var e = zt.instance.getDragingPrintElement(),
                    ...
                    onBeforeDrag: function onBeforeDrag(e) {
                        ...
                        return zt.instance.setDragingPrintElement(n.createPrintElement()), !0;
                    },
                    onDrag: function onDrag(t, e, n) {
                        zt.instance.getDragingPrintElement().updatePosition(e, n);
                    },
                    onStopDrag: function onStopDrag(t) { }
                });
        ...
        Ue = function () {
            return function (t, e) {
                ...
                this.name = t, this.printElementTypes = [], e.forEach(function (t) {
                    n.printElementTypes.push(Xe.createPrintElementType(t));
                });
            };
        }(),
        Ye = function () {
            return function (t) {
                if (this.index = t.index, this.paperType = t.paperType, this.paperType) {
                    var e = zt.instance[this.paperType];
        ...
        Je = function () {
            ...
            return t.prototype.design = function (t) {
            ...
            }, t.prototype.getHtml = function (t, e, n, i) {
                var o = this;
                ...
                var r,
                    ...
                    p = i || this,
                    s = void 0;
                (i ? (s = a[a.length - 1], r = s.getPanelTarget(), s.updateReferenceElement(new kt({
                    top: this.paperHeader,
                    left: 0,
                    height: 0,
                    width: 0,
                    bottomInLastPaper: s.referenceElement.bottomInLastPaper,
                    beginPrintPaperIndex: a.length - 1,
                    printTopInPaper: s.referenceElement.bottomInLastPaper,
                    endPrintPaperIndex: a.length - 1
                }))) : (r = p.createTarget(), s = p.createNewPage(a.length), a.push(s), r.append(s.getTarget())), this.printElements.filter(function (t) {
                    return !t.isFixed() && t.options.getTop() > s.paperHeader && t.options.getTop() < o.paperFooter;
                }).forEach(function (e) {
                    var n = [],
                        i = a[a.length - 1];
                    i.referenceElement.isPositionLeftOrRight(e.options.getTop()) ? (s = a[i.referenceElement.beginPrintPaperIndex], n = e.getHtml(s, t)) : (s = a[i.referenceElement.endPrintPaperIndex], n = e.getHtml(s, t)), n.forEach(function (t, i) {
                        t.referenceElement && (t.referenceElement.endPrintPaperIndex = t.referenceElement.beginPrintPaperIndex + n.length - 1), i > 0 && (s.index < a.length - 1 ? s = a[s.index + 1] : (s = p.createNewPage(a.length, s.referenceElement), a.push(s)), r.append(s.getTarget())), t.target && (s.append(t.target), s.updatePrintLine(t.printLine), e.onRendered(s, t.target)), i == n.length - 1 && t.referenceElement && s.updateReferenceElement(t.referenceElement);
                    });
                }), this.lastPaperFooter) && a[a.length - 1].printLine > this.lastPaperFooter && (s = p.createNewPage(a.length, s.referenceElement), a.push(s), r.append(s.getTarget()));
                return this.panelPaperRule && ("odd" == this.panelPaperRule && a.length % 2 == 0 && (s = p.createNewPage(a.length, s.referenceElement), a.push(s), r.append(s.getTarget())), "even" == this.panelPaperRule && a.length % 2 == 1 && (s = p.createNewPage(a.length, s.referenceElement), a.push(s), r.append(s.getTarget()))), a.forEach(function (n) {
                    n.updatePaperNumber(n.index + 1, a.length, e.paperNumberToggleInEven), o.fillPaperHeaderAndFooter(n, t, a.length), e && (null != e.leftOffset && n.setLeftOffset(e.leftOffset), null != e.topOffset && n.setTopOffset(e.topOffset));
                ...
                t.getTarget().hidroppable({
                    ...
                    onDrop: function onDrop(n, i) {
                        var o = zt.instance.getDragingPrintElement(),
                            r = o.printElement;
                ...
                this.printElements = [], t && t.forEach(function (n) {
                    ...
                    if (i = n.printElementType ? Xe.createPrintElementType(n.printElementType) : a.instance.getElementType(n.tid)) {
                ...
                var e = Rt.instance.movingDistance;
                ...
                var n = new me(this.templateId, this.width, this.height, this.paperHeader, this.paperFooter, this.paperNumberLeft, this.paperNumberTop, this.paperNumberDisabled, this.paperNumberFormat, t, e);
                ...
                var e;
                return (e = t.tid ? a.instance.getElementType(t.tid) : Xe.createPrintElementType(t.printElementType)) || console.log("miss " + JSON.stringify(t)), e;
            ...
            return function (t) {
                if (t) if (t.panels) {
                    ...
                    for (var e = 0; e < t.panels.length; e++) {
                        this.panels.push(new Ye(t.panels[e]));
                    }
                } else this.panels = [];
            };
        }(),
        Ke = function () {
            ...
            return t.prototype.init = function () { }, t.prototype.buildSetting = function (t) {
                ...
                i.getPrintElementOptionItems().forEach(function (t) {
                    t.submit = function (t) {
                        i.submitOption();
                    }, r.append(t.createTarget(i, i.options, i.printElementType)), t.setValue(i.options[t.name], i.options, i.printElementType);
                });
        ...
        tn = function () {
            function t(t) {
                var e = this;
                this.tempimageBase64 = {}, this.id = zt.instance.guid(), zt.instance.setPrintTemplateById(this.id, this);
                var n = t || {};
                this.printPanels = [];
                var i = new Qe(n.template || []);
                n.template && i.panels.forEach(function (t) {
                    e.printPanels.push(new Je(t, e.id));
                }), n.fields && (this.fields = n.fields), n.settingContainer && new Ke(this, n.settingContainer), n.paginationContainer && (this.printPaginationCreator = new Ze(n.paginationContainer, this), this.printPaginationCreator.buildPagination()), this.initAutoSave();
            }
            ...
            return t.prototype.design = function (t, e) {
            ...
            }, t.prototype.getJointHtml = function (t) {
                var e = this,
                    n = $('<div class="hiprint-printTemplate"></div>'),
                    i = void 0,
                    o = [];
                return t.templates.forEach(function (t) {
                    var r = t.data || {},
                        a = t.options || {};
                    e.printPanels.forEach(function (t, e) {
                        n.append(t.getHtml(r, a, o, i)), i = i || t;
                    });
                }), n;
                ...
                var n = t ? new Je(new Ye(t), this.id) : this.createDefaultPanel();
    ...
    function rn(t) {
        Rt.instance.init(t), Rt.instance.providers.forEach(function (t) {
